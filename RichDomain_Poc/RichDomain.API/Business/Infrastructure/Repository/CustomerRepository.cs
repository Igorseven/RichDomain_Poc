...
using RichDomain.API.Business.Insfrastructure.Repository.Base;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Query;
using System.Linq.Expressions;

namespace RichDomain.API.Business.Insfrastructure.Repository;
public sealed class CustomerRepository : BaseRepository<Customer>, ICustomerRepository
{
    ...
    public async Task<PageList<Customer>> FindAllWithpaginationAsync(PageParams pageParams,
